...
// ================
let tR=/[^+/0-9A-Za-z-_]/g;function tv(t,e){let r;e=e||1/0;let n=t.length,i=null,o=[];for(let s=0;s<n;++s){// is surrogate component
 ...
 *
 * @returns {void}
 */function tF(t,e){this._pairs=[],t&&tP(t,this,e)}let tD=tF.prototype;/**
...
ek.addEventListener("click",function(t){t.preventDefault();let e=t.target.classList.contains("gallery__image");if(!e)return;let r=basicLightbox.create(`<img src=${t.target.dataset.source}>`);r.show()}),window.addEventListener("keydown",function t(e){"Escape"===e.code&&fullSizeImage.close(()=>window.removeEventListener("keydown",t))})}();//# sourceMappingURL=index.b157b8dc.js.map

//# sourceMappingURL=index.b157b8dc.js.map
