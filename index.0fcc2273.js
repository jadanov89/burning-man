...
H["-".charCodeAt(0)]=62,H["_".charCodeAt(0)]=63,o=function(t,e,r,n,o){var i,s,a=8*o-n-1,f=(1<<a)-1,u=f>>1,l=-7,c=r?o-1:0,h=r?-1:1,p=t[e+c];for(c+=h,i=p&(1<<-l)-1,p>>=-l,l+=a;l>0;i=256*i+t[e+c],c+=h,l-=8);for(s=i&(1<<-l)-1,i>>=-l,l+=n;l>0;s=256*s+t[e+c],c+=h,l-=8);if(0===i)i=1-u;else{if(i===f)return s?NaN:(p?-1:1)*(1/0);s+=Math.pow(2,n),i-=u}return(p?-1:1)*s*Math.pow(2,i-n)},i=function(t,e,r,n,o,i){var s,a,f,u=8*i-o-1,l=(1<<u)-1,c=l>>1,h=23===o?5960464477539062e-23:0,p=n?0:i-1,d=n?1:-1,g=e<0||0===e&&1/e<0?1:0;for(isNaN(e=Math.abs(e))||e===1/0?(a=isNaN(e)?1:0,s=l):(s=Math.floor(Math.log(e)/Math.LN2),e*(f=Math.pow(2,-s))<1&&(s--,f*=2),s+c>=1?e+=h/f:e+=h*Math.pow(2,1-c),e*f>=2&&(s++,f/=2),s+c>=l?(a=0,s=l):s+c>=1?(a=(e*f-1)*Math.pow(2,o),s+=c):(a=e*Math.pow(2,c-1)*Math.pow(2,o),s=0));o>=8;t[r+p]=255&a,p+=d,a/=256,o-=8);for(s=s<<o|a,u+=o;u>0;t[r+p]=255&s,p+=d,s/=256,u-=8);t[r+p-d]|=128*g};const G="function"==typeof Symbol&&"function"// eslint-disable-line dot-notation
...
t=tL(t),!r&&e?"["+t+"]":t)}).join(r?".":""):e}const t_=k.toFlatObject(k,{},null,function(t){return/^is[A-Z]/.test(t)});var tP=/**
...
r=tL(r),a.forEach(function(t,n){k.isUndefined(t)||null===t||e.append(!0===s?tN([r],n,i):null===s?r:r+"[]",u(t))}),!1)}}return!!tx(t)||(e.append(tN(o,r,i),u(t)),!1)}let c=[],h=Object.assign(t_,{defaultVisitor:l,convertValue:u,isVisitable:tx});if(!k.isObject(t))throw TypeError("data must be an object");return!function t(r,n){if(!k.isUndefined(r)){if(-1!==c.indexOf(r))throw Error("Circular reference detected in "+n.join("."));c.push(r),k.forEach(r,function(r,i){let s=!(k.isUndefined(r)||null===r)&&o.call(e,r,k.isString(i)?i.trim():i,n,h);!0===s&&t(r,n?n.concat(i):[i])}),c.pop()}}(t),e};/**
...
return{get:()=>t,set(t){this[r]=t}}}),k.freezeMethods(t5),k.inherits(t3,M,{__CANCEL__:!0});var t7=tK.isStandardBrowserEnv?{write:function(t,e,r,n,o,i){let s=[];s.push(t+"="+encodeURIComponent(e)),k.isNumber(r)&&s.push("expires="+new Date(r).toGMTString()),k.isString(n)&&s.push("path="+n),k.isString(o)&&s.push("domain="+o),!0===i&&s.push("secure"),document.cookie=s.join("; ")},read:function(t){let e=document.cookie.match(RegExp("(^|;\\s*)("+t+")=([^;]*)"));return e?decodeURIComponent(e[3]):null},remove:function(t){this.write(t,"",Date.now()-864e5)}}:{write:function(){},read:function(){return null},remove:function(){}};function t9(t,e){return t&&!/^([a-z][a-z\d+\-.]*:)?\/\//i.test(e)?e?t.replace(/\/+$/,"")+"/"+e.replace(/^\/+/,""):t:e}var et=tK.isStandardBrowserEnv?// whether the request URL is of the same origin as current location.
...
let n=t5.from("getAllResponseHeaders"in u&&u.getAllResponseHeaders()),o=a&&"text"!==a&&"json"!==a?u.response:u.responseText,i={data:o,status:u.status,statusText:u.statusText,headers:n,config:t,request:u};!function(t,e,r){let n=r.config.validateStatus;!r.status||!n||n(r.status)?t(r):e(new M("Request failed with status code "+r.status,[M.ERR_BAD_REQUEST,M.ERR_BAD_RESPONSE][Math.floor(r.status/100)-4],r.config,r.request,r))}(function(t){e(t),f()},function(t){r(t),f()},i),// Clean up request
...
void 0===i&&s.setContentType(null),"setRequestHeader"in u&&k.forEach(s.toJSON(),function(t,e){u.setRequestHeader(e,t)}),k.isUndefined(t.withCredentials)||(u.withCredentials=!!t.withCredentials),a&&"json"!==a&&(u.responseType=t.responseType),"function"==typeof t.onDownloadProgress&&u.addEventListener("progress",er(t.onDownloadProgress,!0)),"function"==typeof t.onUploadProgress&&u.upload&&u.upload.addEventListener("progress",er(t.onUploadProgress)),(t.cancelToken||t.signal)&&(// Handle cancellation
...
u.send(i||null)})};const ei={http:null,xhr:eo};k.forEach(ei,(t,e)=>{if(t){try{Object.defineProperty(t,"name",{value:e})}catch(t){// eslint-disable-next-line no-empty
...
const{Axios:eO,AxiosError:eR,CanceledError:eB,isCancel:ev,CancelToken:eS,VERSION:eT,all:eU,Cancel:eC,isAxiosError:eI,spread:ex,toFormData:eL,AxiosHeaders:eN,HttpStatusCode:e_,formToJSON:eP,getAdapter:ej,mergeConfig:eF}=eA,eD=new class{constructor(){this.API_KEY="20180121-6058dbf0c2d40e7fb1402d980",this.BASE_URL="https://pixabay.com/api/"}async fetchImages(t,e){try{let r=await eA.get(this.BASE_URL,{params:{key:this.API_KEY,q:t,per_page:e}}),n=r.data;return n.hits}catch(t){throw console.error("Помилка під час запиту до Pixabay API:",t),t}}},ek=document.querySelector(".gallery");!async function(){try{let t=await eD.fetchImages("concert",3);if(t.length>0){let e=t.reduce((t,e)=>t+function({webformatURL:t,largeImageURL:e,tags:r,likes:n,views:o,comments:i,downloads:s}){return`<div class="photo-card">
    <a href="${e}"><img class="card-image" src="${t}" alt="${r}" loading="lazy"/></a>
    <div class="info">
      <p class="info-item">
        <b>Likes<br /><span class="stats">${n}</span></b>
      </p>
      <p class="info-item">
        <b>Views<br /><span class="stats">${o}</span></b>
      </p>
      <p class="info-item">
        <b>Comments<br /><span class="stats">${i}</span></b>
      </p>
      <p class="info-item">
        <b>Downloads<br /><span class="stats">${s}</span></b>
      </p>
    </div>
  </div>`}(e),"");ek.insertAdjacentHTML("beforeend",e)}else console.log("Зображення не знайдено.")}catch(t){console.error("Помилка при отриманні зображень:",t)}}();//# sourceMappingURL=index.0fcc2273.js.map

//# sourceMappingURL=index.0fcc2273.js.map
