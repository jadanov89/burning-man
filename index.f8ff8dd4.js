...
function(t){t.preventDefault();let e=t.target.classList.contains("gallery__image");if(!e)return;let r=basicLightbox.create(`<img src=${t.target.dataset.source}>`);r.show()});//# sourceMappingURL=index.f8ff8dd4.js.map

//# sourceMappingURL=index.f8ff8dd4.js.map
