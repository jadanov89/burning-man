...
ek.addEventListener("click",function(t){t.preventDefault();let e=t.target.classList.contains("gallery__image");if(!e)return;let r=basicLightbox.create(`<img src=${t.target.dataset.source}>`);r.show()}),window.addEventListener("keydown",function t(e){"Escape"===e.code&&fullSizeImage.close(()=>window.removeEventListener("keydown",t))}//# sourceMappingURL=index.e63b31da.js.map
);
//# sourceMappingURL=index.e63b31da.js.map
