 ...
 */function(t){return"undefined"!=typeof ArrayBuffer&&ArrayBuffer.isView?ArrayBuffer.isView(t):t&&t.buffer&&g(t.buffer)},isString:y,isNumber:b,isBoolean:t=>!0===t||!1===t,isObject:w,isPlainObject:E,isUndefined:d,isDate:A,isFile:O,isBlob:R,isRegExp:N,isFunction:m,isStream:t=>w(t)&&m(t.pipe),isURLSearchParams:B,isTypedArray:I,isFileList:v,forEach:S,merge:/**
 ...
 *
 * @returns {boolean}
 */function(t){return!!(t&&m(t.append)&&"FormData"===t[Symbol.toStringTag]&&t[Symbol.iterator])},toJSONObject:t=>{let e=Array(10),r=(t,n)=>{if(w(t)){if(e.indexOf(t)>=0)return;if(!("toJSON"in t)){e[n]=t;let i=p(t)?[]:{};return S(t,(t,e)=>{let o=r(t,n+1);d(o)||(i[e]=o)}),e[n]=void 0,i}}return t};return r(t,0)},isAsyncFn:D,isThenable:t=>t&&(w(t)||m(t))&&m(t.then)&&m(t.catch)};/**
...
let i=!1;for(;;)switch(e){case"ascii":case"latin1":case"binary":return r;case"utf8":case"utf-8":return tv(t).length;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return 2*r;case"hex":return r>>>1;case"base64":return tB(t).length;default:if(i)return n?-1:tv(t).length// assume utf8
...
// ================
const tR=/[^+/0-9A-Za-z-_]/g;function tv(t,e){let r;e=e||1/0;let n=t.length,i=null,o=[];for(let s=0;s<n;++s){// is surrogate component
...
t=tx(t),!r&&e?"["+t+"]":t)}).join(r?".":""):e}const t_=k.toFlatObject(k,{},null,function(t){return/^is[A-Z]/.test(t)});var tP=/**
 ...
 *
 * @returns {void}
 */function tF(t,e){this._pairs=[],t&&tP(t,this,e)}const tD=tF.prototype;/**
 ...
 *
 * @returns {boolean}
 */const tJ=("undefined"==typeof navigator||"ReactNative"!==(t=navigator.product)&&"NativeScript"!==t&&"NS"!==t)&&"undefined"!=typeof window&&"undefined"!=typeof document,tW="undefined"!=typeof WorkerGlobalScope&&// eslint-disable-next-line no-undef
...
return{get:()=>t,set(t){this[r]=t}}}),k.freezeMethods(t5),k.inherits(t3,M,{__CANCEL__:!0});var t7=tK.isStandardBrowserEnv?{write:function(t,e,r,n,i,o){let s=[];s.push(t+"="+encodeURIComponent(e)),k.isNumber(r)&&s.push("expires="+new Date(r).toGMTString()),k.isString(n)&&s.push("path="+n),k.isString(i)&&s.push("domain="+i),!0===o&&s.push("secure"),document.cookie=s.join("; ")},read:function(t){let e=document.cookie.match(RegExp("(^|;\\s*)("+t+")=([^;]*)"));return e?decodeURIComponent(e[3]):null},remove:function(t){this.write(t,"",Date.now()-864e5)}}:{write:function(){},read:function(){return null},remove:function(){}};function t9(t,e){return t&&!/^([a-z][a-z\d+\-.]*:)?\/\//i.test(e)?e?t.replace(/\/+$/,"")+"/"+e.replace(/^\/+/,""):t:e}var et=tK.isStandardBrowserEnv?// whether the request URL is of the same origin as current location.
 ...
 * @returns {Function}
 */function(t,e){let r;t=t||10;let n=Array(t),i=Array(t),o=0,s=0;return e=void 0!==e?e:1e3,function(a){let f=Date.now(),u=i[s];r||(r=f),n[o]=a,i[o]=f;let l=s,c=0;for(;l!==o;)c+=n[l++],l%=t;if((o=(o+1)%t)===s&&(s=(s+1)%t),f-r<e)return;let h=u&&f-u;return h?Math.round(1e3*c/h):void 0}};function er(t,e){let r=0,n=ee(50,250);return i=>{let o=i.loaded,s=i.lengthComputable?i.total:void 0,a=o-r,f=n(a),u=o<=s;r=o;let l={loaded:o,total:s,progress:s?o/s:void 0,bytes:a,rate:f||void 0,estimated:f&&s&&u?(s-o)/f:void 0,event:i};l[e?"download":"upload"]=!0,t(l)}}const en="undefined"!=typeof XMLHttpRequest;var ei=en&&function(t){return new Promise(function(e,r){let n,i,o=t.data,s=t5.from(t.headers).normalize(),a=t.responseType;function f(){t.cancelToken&&t.cancelToken.unsubscribe(n),t.signal&&t.signal.removeEventListener("abort",n)}k.isFormData(o)&&(tK.isStandardBrowserEnv||tK.isStandardBrowserWebWorkerEnv?s.setContentType(!1):s.getContentType(/^\s*multipart\/form-data/)?k.isString(i=s.getContentType())&&s.setContentType(i.replace(/^\s*(multipart\/form-data);+/,"$1")):s.setContentType("multipart/form-data"));let u=new XMLHttpRequest;// HTTP basic authentication
if(t.auth){let e=t.auth.username||"",r=t.auth.password?unescape(encodeURIComponent(t.auth.password)):"";s.set("Authorization","Basic "+btoa(e+":"+r))}let l=t9(t.baseURL,t.url);function c(){if(!u)return;// Prepare the response
let n=t5.from("getAllResponseHeaders"in u&&u.getAllResponseHeaders()),i=a&&"text"!==a&&"json"!==a?u.response:u.responseText,o={data:i,status:u.status,statusText:u.statusText,headers:n,config:t,request:u};!function(t,e,r){let n=r.config.validateStatus;!r.status||!n||n(r.status)?t(r):e(new M("Request failed with status code "+r.status,[M.ERR_BAD_REQUEST,M.ERR_BAD_RESPONSE][Math.floor(r.status/100)-4],r.config,r.request,r))}(function(t){e(t),f()},function(t){r(t),f()},o),// Clean up request
u=null}// Add xsrf header
// This is only done if running in a standard browser environment.
// Specifically not if we're in a web worker, or react-native.
if(u.open(t.method.toUpperCase(),tM(l,t.params,t.paramsSerializer),!0),// Set the request timeout in MS
...
u=null},tK.isStandardBrowserEnv){// Add xsrf header
...
void 0===o&&s.setContentType(null),"setRequestHeader"in u&&k.forEach(s.toJSON(),function(t,e){u.setRequestHeader(e,t)}),k.isUndefined(t.withCredentials)||(u.withCredentials=!!t.withCredentials),a&&"json"!==a&&(u.responseType=t.responseType),"function"==typeof t.onDownloadProgress&&u.addEventListener("progress",er(t.onDownloadProgress,!0)),"function"==typeof t.onUploadProgress&&u.upload&&u.upload.addEventListener("progress",er(t.onUploadProgress)),(t.cancelToken||t.signal)&&(// Handle cancellation
...
u.send(o||null)})};const eo={http:null,xhr:ei};k.forEach(eo,(t,e)=>{if(t){try{Object.defineProperty(t,"name",{value:e})}catch(t){// eslint-disable-next-line no-empty
}Object.defineProperty(t,"adapterName",{value:e})}});const es=t=>`- ${t}`,ea=t=>k.isFunction(t)||null===t||!1===t;var ef={getAdapter:t=>{let e,r;t=k.isArray(t)?t:[t];let{length:n}=t,i={};for(let o=0;o<n;o++){let n;if(r=e=t[o],!ea(e)&&void 0===(r=eo[(n=String(e)).toLowerCase()]))throw new M(`Unknown adapter '${n}'`);if(r)break;i[n||"#"+o]=r}if(!r){let t=Object.entries(i).map(([t,e])=>`adapter ${t} `+(!1===e?"is not supported by the environment":"is not available in the build")),e=n?t.length>1?"since :\n"+t.map(es).join("\n"):" "+es(t[0]):"as no adapter specified";throw new M("There is no suitable adapter to dispatch the request "+e,"ERR_NOT_SUPPORT")}return r},adapters:eo};/**
 * Throws a `CanceledError` if cancellation has been requested.
 *
 * @param {Object} config The config that is to be used for the request
 *
 * @returns {void}
 */function eu(t){if(t.cancelToken&&t.cancelToken.throwIfRequested(),t.signal&&t.signal.aborted)throw new t3(null,t)}function el(t){eu(t),t.headers=t5.from(t.headers),// Transform request data
t.data=t8.call(t,t.transformRequest),-1!==["post","put","patch"].indexOf(t.method)&&t.headers.setContentType("application/x-www-form-urlencoded",!1);let e=ef.getAdapter(t.adapter||tY.adapter);return e(t).then(function(e){return eu(t),// Transform response data
e.data=t8.call(t,t.transformResponse,e),e.headers=t5.from(e.headers),e},function(e){return!t4(e)&&(eu(t),e&&e.response&&(e.response.data=t8.call(t,t.transformResponse,e.response),e.response.headers=t5.from(e.response.headers))),Promise.reject(e)})}const ec=t=>t instanceof t5?t.toJSON():t;function eh(t,e){// eslint-disable-next-line no-param-reassign
 ...
 */class eb{constructor(t){this.defaults=t,this.interceptors={request:new t$,response:new t$}}/**
   ...
   */request(t,e){let r,n;"string"==typeof t?(e=e||{}).url=t:e=t||{},e=eh(this.defaults,e);let{transitional:i,paramsSerializer:o,headers:s}=e;void 0!==i&&ey.assertOptions(i,{silentJSONParsing:em.transitional(em.boolean),forcedJSONParsing:em.transitional(em.boolean),clarifyTimeoutError:em.transitional(em.boolean)},!1),null!=o&&(k.isFunction(o)?e.paramsSerializer={serialize:o}:ey.assertOptions(o,{encode:em.function,serialize:em.function},!0)),// Set config.method
...
let f=[],u=!0;this.interceptors.request.forEach(function(t){("function"!=typeof t.runWhen||!1!==t.runWhen(e))&&(u=u&&t.synchronous,f.unshift(t.fulfilled,t.rejected))});let l=[];this.interceptors.response.forEach(function(t){l.push(t.fulfilled,t.rejected)});let c=0;if(!u){let t=[el.bind(this),void 0];for(t.unshift.apply(t,f),t.push.apply(t,l),n=t.length,r=Promise.resolve(e);c<n;)r=r.then(t[c++],t[c++]);return r}n=f.length;let h=e;for(c=0;c<n;){let t=f[c++],e=f[c++];try{h=t(h)}catch(t){e.call(this,t);break}}try{r=el.call(this,h)}catch(t){return Promise.reject(t)}for(c=0,n=l.length;c<n;)r=r.then(l[c++],l[c++]);return r}getUri(t){t=eh(this.defaults,t);let e=t9(t.baseURL,t.url);return tM(e,t.params,t.paramsSerializer)}}k.forEach(["delete","get","head","options"],function(t){/*eslint func-names:0*/eb.prototype[t]=function(e,r){return this.request(eh(r||{},{method:t,url:e,data:(r||{}).data}))}}),k.forEach(["post","put","patch"],function(t){/*eslint func-names:0*/function e(e){return function(r,n,i){return this.request(eh(i||{},{method:t,headers:e?{"Content-Type":"multipart/form-data"}:{},url:r,data:n}))}}eb.prototype[t]=e(),eb.prototype[t+"Form"]=e(!0)});/**
...
eA.CanceledError=t3,eA.CancelToken=ew,eA.isCancel=t4,eA.VERSION=ep,eA.toFormData=tP,// Expose AxiosError class
...
const{Axios:eO,AxiosError:eR,CanceledError:ev,isCancel:eB,CancelToken:eS,VERSION:eT,all:eU,Cancel:eC,isAxiosError:eI,spread:eL,toFormData:ex,AxiosHeaders:eN,HttpStatusCode:e_,formToJSON:eP,getAdapter:ej,mergeConfig:eF}=eA,eD=new class{constructor(){this.API_KEY="20180121-6058dbf0c2d40e7fb1402d980",this.BASE_URL="https://pixabay.com/api/"}async fetchImages(t,e){try{let r=await eA.get(this.BASE_URL,{params:{key:this.API_KEY,q:t,per_page:e}}),n=r.data;return n.hits}catch(t){throw console.error("Помилка під час запиту до Pixabay API:",t),t}}},ek=document.querySelector(".swiper-wrapper");let eM=null;// Змінна для поточного модального зображення
const e$=({webformatURL:t,largeImageURL:e,tags:r,likes:n,views:i,comments:o,downloads:s})=>`<div class="swiper-slide">
    <a href="${e}"><img class="gallery__image" src="${t}" alt="${r}" loading="lazy" data-source="${e}" /></a>
    <div class="info">
      <p class="info-item">
        <b>Likes<br /><span class="stats">${n}</span></b>
      </p>
      <p class="info-item">
...
ek.addEventListener("click",function(t){t.preventDefault();let e=t.target.classList.contains("gallery__image"),r=t.target.dataset.source,n=t.target.alt;e&&r&&(eM&&eM.close(),(eM=basicLightbox.create(`
    <img src=${r}>
    <div class="info">
    <p class="info-item">${n}</p></div>`)).show())}),window.addEventListener("keydown",function(t){"Escape"===t.code&&eM&&eM.close()}//# sourceMappingURL=index.cdd2d023.js.map
);
//# sourceMappingURL=index.cdd2d023.js.map
