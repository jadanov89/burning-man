 ...
 */function(t){return"undefined"!=typeof ArrayBuffer&&ArrayBuffer.isView?ArrayBuffer.isView(t):t&&t.buffer&&g(t.buffer)},isString:y,isNumber:b,isBoolean:t=>!0===t||!1===t,isObject:w,isPlainObject:E,isUndefined:d,isDate:A,isFile:O,isBlob:R,isRegExp:N,isFunction:m,isStream:t=>w(t)&&m(t.pipe),isURLSearchParams:v,isTypedArray:I,isFileList:B,forEach:S,merge:/**
...
// ================
const tR=/[^+/0-9A-Za-z-_]/g;function tB(t,e){let r;e=e||1/0;let n=t.length,i=null,o=[];for(let s=0;s<n;++s){// is surrogate component
...
ek.addEventListener("click",function(t){t.preventDefault();let e=t.target.classList.contains("gallery__image"),r=t.target.dataset.source;e&&r&&(eM&&eM.close(),(eM=basicLightbox.create(`<img src=${r}>`)).show())}),window.addEventListener("keydown",function(t){"Escape"===t.code&&eM&&eM.close()}//# sourceMappingURL=index.08a25cad.js.map
);
//# sourceMappingURL=index.08a25cad.js.map
