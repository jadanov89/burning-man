...
let{Axios:eO,AxiosError:eR,CanceledError:eB,isCancel:ev,CancelToken:eS,VERSION:eT,all:eU,Cancel:eC,isAxiosError:eI,spread:ex,toFormData:eL,AxiosHeaders:eN,HttpStatusCode:e_,formToJSON:eP,getAdapter:ej,mergeConfig:eF}=eA,eD=new class{constructor(){this.API_KEY="20180121-6058dbf0c2d40e7fb1402d980",this.BASE_URL="https://pixabay.com/api/"}async fetchImages(t,e){try{let r=await eA.get(this.BASE_URL,{params:{key:this.API_KEY,q:t,per_page:e}}),n=r.data;return n.hits}catch(t){throw console.error("Помилка під час запиту до Pixabay API:",t),t}}},ek=document.querySelector(".gallery");!async function(){try{let t=await eD.fetchImages("concert",3);if(t.length>0){let e=t.reduce((t,e)=>t+function({webformatURL:t,largeImageURL:e,tags:r,likes:n,views:i,comments:o,downloads:s}){return`<div class="photo-card">
  ...
  </div>`}(e),"");ek.insertAdjacentHTML("beforeend",e)}else console.log("Зображення не знайдено.")}catch(t){console.error("Помилка при отриманні зображень:",t)}}()}();//# sourceMappingURL=index.a60fb1e6.js.map

//# sourceMappingURL=index.a60fb1e6.js.map
