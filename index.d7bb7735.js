...
ek.addEventListener("click",function(t){t.preventDefault();let e=t.target.classList.contains("gallery__image"),r=t.target.dataset.source,n=t.target.alt;e&&r&&(eM&&eM.close(),(eM=basicLightbox.create(`
    <img src=${r}>
    <div class="info">
    <p class="info-item">${n}</p></div>`)).show())}),window.addEventListener("keydown",function(t){"Escape"===t.code&&eM&&eM.close()})}();//# sourceMappingURL=index.d7bb7735.js.map

//# sourceMappingURL=index.d7bb7735.js.map
